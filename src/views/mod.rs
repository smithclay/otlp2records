...
//!
//! The traits in [`pdata`] are kept source-compatible with the logs, traces,
//! and metrics views of `otap-df-pdata-views` from the OpenTelemetry Arrow
//! repository. Upstream does
