...
impl TransformObserver for PhaseTotals {
    fn on_phase(&mut self, timing: TransformPhaseTiming) {
        match timing.phase {
            ...
            TransformPhase::ResourceLogsBuild => self.resource_logs_build += timing.elapsed,
            ...
            TransformPhase::ScopeLogsBuild => self.scope_logs_build += timing.elapsed,
            ...
            TransformPhase::LogRecordBuild => self.log_record_build += timing.elapsed,
...
fn print_measurement(workload: &Workload, fixture_bytes: usize, measurement: &Measurement) {
    ...
    println!(
        "profile,{},{},{},{},{:.3},{:.3},{:.0},{:.1},{:.1},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{},{},{},{},{},{},{}",
        workload.name,
        fixture_bytes,
